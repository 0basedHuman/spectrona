...
**Last run:** 2026-09-24 (Session 088 — R8 corpus expansion shard)
**Result:** PASS
...
- [x] Reviewed corpus has at least 697 labeled cases
- [x] Benchmark reports per-rule precision and recall
- [x] Measured rules pass the 95% precision gate on the 697-case reviewed corpus
...
- [x] Six hundred eighty-five public GitHub queue records were manually reviewed and promoted into the benchmark corpus
- [x] Benchmark reports a measured `MCP_UNPINNED_PACKAGE` recall gap: 244 true positives, 44 false negatives, 0 false positives
