...
**Last run:** 2026-09-13 (Session 082 — R8 corpus labeling shard)
**Result:** PASS
...
- [x] Reviewed corpus has at least 88 labeled cases
- [x] Benchmark reports per-rule precision and recall
- [x] Measured rules pass the 95% precision gate on the 88-case reviewed corpus
...
- [x] Seventy-six public GitHub queue records were manually reviewed and promoted into the benchmark corpus
