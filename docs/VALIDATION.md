...
**Last run:** 2026-09-22 (Session 085 — R8 fresh harvest shard)
**Result:** PASS
...
- [x] Reviewed corpus has at least 277 labeled cases
- [x] Benchmark reports per-rule precision and recall
- [x] Measured rules pass the 95% precision gate on the 277-case reviewed corpus
...
- [x] Two hundred sixty-five public GitHub queue records were manually reviewed and promoted into the benchmark corpus
- [x] Benchmark reports a measured `MCP_UNPINNED_PACKAGE` recall gap: 113 true positives, 9 false negatives, 0 false positives
