...
**Last run:** 2026-09-13 (Session 081 — R8 corpus precision shard)
**Result:** PASS
...
- [x] Reviewed corpus has at least 44 labeled cases
- [x] Benchmark reports per-rule precision and recall
- [x] Measured rules pass the 95% precision gate on the 44-case reviewed corpus
...
- [x] Thirty-two public GitHub queue records were manually reviewed and promoted into the benchmark corpus
