...
- [x] Reviewed corpus has at least 1,000 labeled cases
- [x] Benchmark reports per-rule precision and recall
- [x] Measured rules pass the 95% precision gate on the 1,030-case reviewed corpus
...
- [x] One thousand eighteen public GitHub queue records were manually reviewed and promoted into the benchmark corpus
- [x] Benchmark reports a measured `MCP_UNPINNED_PACKAGE` recall gap: 316 true positives, 184 false negatives, 0 false positives
