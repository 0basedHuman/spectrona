...
- [ ] Investigate the 41 measured `MCP_UNPINNED_PACKAGE` false negatives exposed by the 569-case corpus; keep any detector change scoped to an existing rule and prove it against the corpus precision gate.
